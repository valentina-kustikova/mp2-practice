...
TEST(TVector, can_take_vectors_sum_with_equal_size) {
...
TEST(TVector, can_take_vectors_difference_with_equal_size) {
	TVector<int> vec1(3), vec2(3), vec3(3);
	vec1[0] = 1;
	vec1[1] = 2;
	vec1[2] = 3;
...
TEST(TVector, can_take_vectors_mul_with_equal_size) {
	TVector<int> vec1(3), vec2(3);
	vec1[0] = 1;
	vec1[1] = 2;
	vec1[2] = 3;
