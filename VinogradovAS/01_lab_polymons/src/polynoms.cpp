...
//	}*/
//
//		//Ïîñëåäíèé âñòðå÷åííûé çíàê êîýôôèöèåíòà
//		char lastsgn = '+';
//
//		//Âðåìåííûé ìîíîì äëÿ çàïèñè äàííûõ
//		TMonom tm(1, 0, 0, 0);
//		ostringstream ss;
//
//		int i = 0;
...
//			else if (polyStr[i] == 'x' || polyStr[i] == 'X')
//			{
//				//Ýòî êîíåö ñòðîêè (ñòåïåíü 1)
//				if (i + 1 == polyStr.size())
//				{
//					ss << 'x';
//					tm.x += 1;
//				}
//				//Ìîíîì èìååò ÿâíóþ ñòåïåíü (íå 1)
//				else if (isdigit(polyStr[i + 1]))
//				{
//					size_t idx;
//					double digit = stod(&polyStr[i + 1], &idx);
...
//				}
//			}
//			//Ïåðåõîä ê ñ÷èòûâàíèþ ñëåäóþùåãî ìîíîìà
//			else if (polyStr[i] == '+' || polyStr[i] == '-')
//			{
//				if (lastsgn == '-') tm.coeff *= (-1);
//				AddMonom(tm);
...
//	}
//
//	//Âûâîä äëÿ ïåðâîãî ìîíîìà ïîëèíîìà
//	TMonom m = _pCurr->value;
//	double absCoeff = fabs(m.coeff);
//
//	if (m.coeff < 0) os << "- ";
//
//	//Ìîíîì áûë êîíñòàíòíûé
//	if (m.IsConst())
//	{
//		os << absCoeff;
//	}
